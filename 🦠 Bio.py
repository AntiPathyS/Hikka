...
Ваша вторая рука в биовойнах)
    ...
    strings = {
        ...
        "r.save":   
            "<emoji document_id=5456201430635386946>👌</emoji>  Жертва <b><code>{}</code></b> сохранена.\n"
            "<b>☣️ +{}{}</b> био-опыта.",
        "auto.save":   
            "<emoji document_id=5456201430635386946>👌</emoji>  Жертва <b><code>{}</code></b> сохранена.\n"
            "<b>☣️ {}+{}</b> био-опыта.",        
        "search":
            "<emoji document_id=5456181450447527779>🌞</emoji> Жертва <code>{}</code> приносит:\n"
            "<b>☣️ +{} био-опыта.</b>\n",
        
        "nf": "<emoji document_id=5456299961480125545>🔫</emoji> Жертва не найдена.",
        
        "no_user": "<emoji document_id=5456299961480125545>🔫</emoji> user {} don't exist.",

        "nous": "<emoji document_id=5456299961480125545>🔫</emoji> Жертва или пользователь не существует.",
        ...
        "user_add": "<emoji document_id=5456181450447527779>🌞</emoji> Саппорт <b><code>{}</code></b> добавлен!",
        
        "wrong_nick": "<b>📝 Введите ник.</b>",
        
        "nick_add": "🔰 Ник <b>{}</b> установлен!",
        
        "dov_start": "<b><emoji document_id=5456181450447527779>🌞</emoji> Успешно запущено!</b>",
        ...
        "tids": "<b><emoji document_id=5456181450447527779>🌞</emoji> Id'ы успешно извлечены.</b>",
        
        "tzar": "<emoji document_id=5456181450447527779>🌞</emoji> Заражения завершены.",
