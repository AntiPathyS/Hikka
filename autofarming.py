...
class IrisMod(loader.Module):
    ...
    strings = {
        ...
        "farmoff": "<i>❌Автофарминг остановлен.\n☢️Нафармлено:</i> <b>%coins% i¢</b>",
        "farm": "<i>☢️Нафармлено:</i> <b>%coins% i¢</b>",
    }
    ...
    async def farmoncmd(self, message):
        ...
        await self.client.send_message(
            self.iris, "Ферма \nAutofarming", schedule=timedelta(seconds=20)
        )
    ...
    async def watcher(self, event):
        ...
        if event.raw_text == "Ферма \nAutofarming":
            return await self.client.send_message(
                self.iris, "Ферма \nAutofarming", schedule=timedelta(minutes=random.randint(1, 20))
            )
        ...
        if "НЕЗАЧЁТ!" in event.raw_text:
            ...
            return await self.client.send_message(self.iris, "Ферма \nAutofarming", schedule=delta)
